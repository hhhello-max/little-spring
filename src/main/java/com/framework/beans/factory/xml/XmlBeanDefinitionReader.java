...
import com.framework.beans.factory.support.AbstractBeanDefinitionReader;
import com.framework.beans.factory.support.BeanDefinitionRegistry;
import com.framework.context.annotation.ClassPathBeanDefinitionScanner;
    ...
    protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException, DocumentException {
        ...
        if (componentScan != null){
            ...
            if (StrUtil.isEmpty(scanPath)){
                throw new BeansException("Scan failed");
            }
