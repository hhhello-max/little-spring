...
import com.framework.core.BridgeMethodResolver;
...
public class AnnotatedElementUtil {
    ...
    public static AnnotationAttributes findMergedAnnotationAttribute(AnnotatedElement element,
                                                                     Class<? extends Annotation> annotationType,
                                                                     boolean classValueAsString,
                                                                     boolean nestedAnnotationsAsMap){
        return searchWithFindSemantics(element, annotationType, null, new MergedAnnotationAttributesProcessor(classValueAsString, nestedAnnotationsAsMap));
    }
